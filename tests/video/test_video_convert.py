...
class TestConversionPreset:
    ...
    def test_conversion_preset_creation(self):
        ...
        assert preset.include_subs is True
    ...
    def test_vanilla_with_subs_preset(self):
        ...
        assert VANILLA_WITH_SUBS.include_subs is True
    ...
    def test_vanilla_no_subs_preset(self):
        ...
        assert VANILLA_NO_SUBS.include_subs is False
...
class TestConvertMkvToMp4:
    ...
    def test_convert_mkv_overwrite_existing(self, mock_run):
        ...
        with patch("pathlib.Path.exists", return_value=True):
            result = convert_mkv_to_mp4(
                input_path, output_path, VANILLA_WITH_SUBS, overwrite=True
            )

        assert result is True
        mock_run.assert_called_once()

    # Skip test for convert-level skip; skip logic is covered by batch conversion tests
...
class TestBatchConvertMkvToMp4:
    ...
    def test_batch_convert_fallback_to_no_subs(self, mock_convert):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from mpv_scraper.video_convert import batch_convert_mkv_to_mp4_with_fallback

            result = batch_convert_mkv_to_mp4_with_fallback(temp_path)
    ...
    def test_batch_convert_skip_existing(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("mpv_scraper.video_convert.convert_mkv_to_mp4") as mock_convert:
                result = batch_convert_mkv_to_mp4(
                    temp_path, VANILLA_WITH_SUBS, overwrite=False
                )
    ...
    def test_batch_convert_overwrite_existing(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("mpv_scraper.video_convert.convert_mkv_to_mp4") as mock_convert:
                mock_convert.return_value = True
                result = batch_convert_mkv_to_mp4(
                    temp_path, VANILLA_WITH_SUBS, overwrite=True
                )
